...
5.2.11
-----------------
 * itlo\cms\models\Tree - new method getActiveChildren();
...
5.2.2
----------------
 * Fixed https://github.com/itlo-cms/cms/pull/118
...
5.1.0
----------------
 * Update itlo/yii2-sx 1.4.0
 * Update yii2 2.0.15
 * IHasInfo is deprecated
 * Fixed create new dir
 * ClusterLocal update set publicBaseUrl and rootBasePath
 * Removed itlo\cms\Exception
 * Widget and component settings to use itlo/yii2-form
...
5.0.0-alpha12
----------------
 * Fixed Class 'itlo\cms\relatedProperties\propertyTypes\PropertyTypeStorageFile' not found
 ...
 * Use itlo/cms-toolbar
 * Removed itlo/cms/components/CmsToolbar
 * Fixed filters
 * Rebuild config profiling
 
5.0.0-alpha
---------------
 * Removed itlo\cms\composer. Use itlo/cms-composer.
...
4.0.4
---------------
 * Used https://github.com/itlo-semenov/yii2-ya-slug.
 * Removed slug behavior https://github.com/itlo-semenov/yii2-slug-behavior.
...
4.0.2
---------------
 * Removed SeoPageName Behavior. Now used https://github.com/itlo-semenov/yii2-slug-behavior.
 ...
 * Removed itlo\cms\base\CheckComponent
 * Removed itlo\cms\traits\ValidateRulesTrait
 * Removed itlo\cms\Config
 * Change code folder /src
 * Url changes


### https://github.com/itlo-cms/cms/blob/master/changelogs/CHANGELOG-V1.md
### https://github.com/itlo-cms/cms/blob/master/changelogs/CHANGELOG-V2.md
### https://github.com/itlo-cms/cms/blob/master/changelogs/CHANGELOG-V3.md
