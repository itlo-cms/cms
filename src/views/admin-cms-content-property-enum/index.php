...
$query->select([\itlo\cms\models\CmsContentPropertyEnum::tableName() . '.*', 'p.name as p_name']);
    ...
    'columns' =>
        [
            ...
            [
                'label' => \Yii::t('itlo/cms', 'Property'),
                'attribute' => 'p.name',
                'value' => function(\itlo\cms\models\CmsContentPropertyEnum $cmsContentPropertyEnum) {
